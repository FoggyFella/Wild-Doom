...
func _input(event):
	if event is InputEventJoypadButton:
		on_controller = true
		if $HBoxContainer/PreviousButton.disabled == false or $HBoxContainer/NextButton.disabled == false:
			enable_controller_stuff()
...
func enable_controller_stuff():
	$EquipAndBuyController.show()
	$HBoxContainer/PreviousButton/LT.show()
	$HBoxContainer/NextButton/RT.show()
	$MainMenu/LT.show()
	$MainMenu/LT2.show()

func disable_controller_stuff():
	$EquipAndBuyController.hide()
	$HBoxContainer/PreviousButton/LT.hide()
	$HBoxContainer/NextButton/RT.hide()
	$MainMenu/LT.hide()
	$MainMenu/LT2.hide()
